...
NV_NVDLA_SDP_rdma u_rdma (
  ...
  ,.sdp_b2cvif_rd_req_pd (sdp_b2cvif_rd_req_pd[47 -1:0])
  ,.cvif2sdp_b_rd_rsp_valid (cvif2sdp_b_rd_rsp_valid)
  ,.cvif2sdp_b_rd_rsp_ready (cvif2sdp_b_rd_rsp_ready)
  ,.cvif2sdp_b_rd_rsp_pd (cvif2sdp_b_rd_rsp_pd[65 -1:0])
  ...
  ,.sdp_e2cvif_rd_req_pd (sdp_e2cvif_rd_req_pd[47 -1:0])
  ,.cvif2sdp_e_rd_rsp_valid (cvif2sdp_e_rd_rsp_valid)
  ,.cvif2sdp_e_rd_rsp_ready (cvif2sdp_e_rd_rsp_ready)
  ,.cvif2sdp_e_rd_rsp_pd (cvif2sdp_e_rd_rsp_pd[65 -1:0])
  ...
  ,.sdp_n2cvif_rd_req_pd (sdp_n2cvif_rd_req_pd[47 -1:0])
  ,.cvif2sdp_n_rd_rsp_valid (cvif2sdp_n_rd_rsp_valid)
  ,.cvif2sdp_n_rd_rsp_ready (cvif2sdp_n_rd_rsp_ready)
  ,.cvif2sdp_n_rd_rsp_pd (cvif2sdp_n_rd_rsp_pd[65 -1:0])
  ...
  ,.sdp2cvif_rd_req_pd (sdp2cvif_rd_req_pd[47 -1:0])
  ,.cvif2sdp_rd_rsp_valid (cvif2sdp_rd_rsp_valid)
  ,.cvif2sdp_rd_rsp_ready (cvif2sdp_rd_rsp_ready)
  ,.cvif2sdp_rd_rsp_pd (cvif2sdp_rd_rsp_pd[65 -1:0])
...
NV_NVDLA_SDP_wdma u_wdma (
  ...
  ,.sdp2cvif_wr_req_pd (sdp2cvif_wr_req_pd[66 -1:0])
