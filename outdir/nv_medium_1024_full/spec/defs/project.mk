...
NVDLA_SDP_BS_THROUGHPUT := 8
NVDLA_SDP_BN_THROUGHPUT := 8
NVDLA_SDP_EW_THROUGHPUT := 2
NVDLA_SDP_EW_THROUGHPUT_LOG2 := 1
NVDLA_SDP_MAX_THROUGHPUT := 8
NVDLA_SDP2PDP_WIDTH := 64
NVDLA_PDP_THROUGHPUT := 4
NVDLA_CDP_THROUGHPUT := 4
...
PDP_SINGLE_LBUF_DEPTH := 56
NVDLA_VMOD_PRIMARY_BANDWIDTH := 8
NVDLA_VMOD_SDP_MRDMA_OUTPUT_THROUGHPUT := 8
NVDLA_VMOD_SDP_BRDMA_OUTPUT_THROUGHPUT := 32
NVDLA_VMOD_SDP_NRDMA_OUTPUT_THROUGHPUT := 32
NVDLA_VMOD_SDP_ERDMA_OUTPUT_THROUGHPUT := 8
NVDLA_VMOD_CDP_RDMA_OUTPUT_THROUGHPUT_USE := 4
NVDLA_VMOD_PDP_RDMA_OUTPUT_THROUGHPUT_USE := 4
