...
input [16*2 -1:0] ew_alu_in_data;
input ew_alu_in_vld;
output ew_alu_in_rdy;
input [32*2 -1:0] ew_data_in_pd;
input ew_data_in_pvld;
output ew_data_in_prdy;
input [16*2 -1:0] ew_mul_in_data;
input ew_mul_in_vld;
output ew_mul_in_rdy;
output [32*2 -1:0] ew_data_out_pd;
...
wire [32*2 -1:0] alu_cvt_out_pd;
wire alu_cvt_out_prdy;
wire alu_cvt_out_pvld;
wire [32*2 -1:0] mul_cvt_out_pd;
wire mul_cvt_out_prdy;
wire mul_cvt_out_pvld;
wire [32*2 -1:0] core_out_pd;
wire core_out_prdy;
wire core_out_pvld;
wire [81*2 -1:0] idx2lut_pd;
wire idx2lut_prdy;
wire idx2lut_pvld;
wire [32*2 -1:0] idx_in_pd;
wire idx_in_prdy;
wire idx_in_pvld;
wire [32*2 -1:0] inp_out_pd;
wire inp_out_prdy;
wire inp_out_pvld;
...
assign idx_in_pd = {32*2{idx_in_pvld}} & core_out_pd;
...
NV_NVDLA_SDP_CORE_Y_lut u_lut (
  ...
  ,.lut2inp_pd (lut2inp_pd[185*2 -1:0]) //|> w
  ,.idx2lut_pvld (idx2lut_pvld) //|< w
  ,.idx2lut_prdy (idx2lut_prdy) //|> w
  ,.idx2lut_pd (idx2lut_pd[81*2 -1:0]) //|< w
